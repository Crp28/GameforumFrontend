                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/privacy" className="text-gray-300 hover:text-primary transition-colors">Privacy Policy</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="mt-4">
                            <button className="btn-primary w-full">Subscribe to Newsletter</button>
                        </div>
                    </div>
                </div>

                <div className="border-t border-primary/20 mt-8 pt-6 text-center">
                    <p className="text-sm text-gray-300">&copy; {new Date().getFullYear()} GameForum. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
